...
namespace StudentPerformance.ViewModels
{
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
            new Student { Name = "Зубенко Михаил Петрович", Elec = 0, Comp_Net = 1, Comp_Arch = 2, Prob_Theory = 1, Calculus = 0, Comp_Math = 2, PI = 1, Vis_Prog = 0 },
            new Student { Name = "Николаев Михаил Александрович", Elec = 1, Comp_Net = 1, Comp_Arch = 1, Prob_Theory = 1, Calculus = 1, Comp_Math = 1, PI = 1, Vis_Prog = 1 },
            new Student { Name = "Котов Венидикт Карпович", Elec = 2, Comp_Net = 1, Comp_Arch = 2, Prob_Theory = 1, Calculus = 2, Comp_Math = 1, PI = 2, Vis_Prog = 2 },
            };
